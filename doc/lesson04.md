...
- Ревью проекта входит в продписку с проверкой домашних заданий (ревьюится один раз). Отдать на ревью нужно спустя не позднее 3х недель после окончания нашего проекта topjava (до 07.07).
